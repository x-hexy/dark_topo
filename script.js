...
var options = {
    ...
    groups: {
        Kahnwald: { color: { background: "#4a2e2e", border: "#6a4e4e" } },
        Nielsen: { color: { background: "#2e4a2e", border: "#4e6a4e" } },
        Doppler: { color: { background: "#2e2e4a", border: "#4e4e6a" } },
        Tiedemann: { color: { background: "#4a4a2e", border: "#6a6a4e" } }
    },
